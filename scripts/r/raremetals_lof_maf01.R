...
write.table(counter, paste("results/chr", CHROM, "/Lof_maf01_WSS_casecontrol_chr", CHROM, ".finished", sep=""), sep="\t", quote=FALSE, row.names=FALSE, col.names=TRUE)
...
write.table(counter, paste("results/chr", CHROM, "/Lof_maf01_WSS_caseonly_chr", CHROM, ".finished", sep=""), sep="\t", quote=FALSE, row.names=FALSE, col.names=TRUE)
...
write.table(counter, paste("results/chr", CHROM, "/Lof_maf01_GRANVIL_casecontrol_chr", CHROM, ".finished", sep=""), sep="\t", quote=FALSE, row.names=FALSE, col.names=TRUE)
...
write.table(counter, paste("results/chr", CHROM, "/Lof_maf01_GRANVIL_caseonly_chr", CHROM, ".finished", sep=""), sep="\t", quote=FALSE, row.names=FALSE, col.names=TRUE)
...
write.table(counter, paste("results/chr", CHROM, "/Lof_maf01_SKAT_casecontrol_chr", CHROM, ".finished", sep=""), sep="\t", quote=FALSE, row.names=FALSE, col.names=TRUE)
...
write.table(counter, paste("results/chr", CHROM, "/Lof_maf01_SKAT_caseonly_chr", CHROM, ".finished", sep=""), sep="\t", quote=FALSE, row.names=FALSE, col.names=TRUE)
...
write.table(counter, paste("results/chr", CHROM, "/Lof_maf01_VT_casecontrol_chr", CHROM, ".finished", sep=""), sep="\t", quote=FALSE, row.names=FALSE, col.names=TRUE)
...
write.table(counter, paste("results/chr", CHROM, "/Lof_maf01_VT_caseonly_chr", CHROM, ".finished", sep=""), sep="\t", quote=FALSE, row.names=FALSE, col.names=TRUE)
